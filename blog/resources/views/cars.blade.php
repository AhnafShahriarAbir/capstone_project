...
<td>Holden Berline<a href="/carinfo/{{5}}"><img width="100px" height="100px" class="display" src="{{ asset('images\holdenberlina2006.jpg') }}"></a></td>
...
<td>Holden Ute-SV6<a href="/carinfo/{{5}}"><img width="100px" height="100px" class="display" src="{{ asset('images\hol2.jpg') }}"></a></td>
...
<button style="margin:5px;">Book Car</button>
<button style="margin:5px;">Book Car</button>
<button style="margin:5px;">Book Car</button>
